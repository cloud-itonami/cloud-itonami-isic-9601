...
- the Garment Care Governor remains independent of the advisor.
- hard policy violations (fabricated verification, incomplete records) cannot be
  overridden by human approval.
- applying a cleaning process or returning a garment always escalates to a human -- never automated.
...
- bypassing the Garment Care Governor's policy checks
