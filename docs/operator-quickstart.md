# Operator Quickstart — Washing and

Shortest path from clone to a verified local dry-run for **ISIC 9601** (`cloud-itonami-isic-9601`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9601.git
cd cloud-itonami-isic-9601
```
...
- Blueprint governor key: `garment-care-governor`
- Likely source path: `laundry.governor.cljc`
